...
o_fid = 'sc-traces-AES\20191226-0001_'; 		% enPiT_enshuF\Day2\data\ の中に入っているフォルダ名と(途中までの)ファイル名
PM_fid = 'PowerModel\Byte8';	% enPiT_enshuF\Day2\program\octave\PowerModel\ の中に入っているフォルダ名 Byte○○

PM1_f_name = '0D21.txt';      		% .\PowerModel\Byte**内の4つのファイルの名前を順に入れる
PM2_f_name = '13FE.txt';
PM3_f_name = '40AF.txt';
PM4_f_name = 'CC1B.txt';
